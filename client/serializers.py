...
class ListOfProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = ListOfProduct
        fields = ('user', 'user_name', 'client', 'client_name', 'service_name', 'service_detail')
...
class AddClientSerializer(serializers.ModelSerializer):
    ...
    #     instance.client_listofproduct = validated_data.get('client_listofproduct', instance.client_listofproduct)
